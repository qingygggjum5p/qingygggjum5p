...
/*************************************************************
* 扫描超时时间设置  0关闭超时  1->1ms   2->1.5ms  3->2ms   4->3ms  5->5ms   6->10ms  7->100ms
**********************************************************/
	...
	byTkeyTckdiv = 0;		//低功耗模式下的TKEY时钟分频设置，FIMOSC/(byTkeyTckdiv + 1) = 1MHz			
	byTkeyPckdiv = 0;		//运行模式下的TKEY时钟分频设置，FSYSCLK/(byTkeyPckdiv + 1) = 1MHz
}