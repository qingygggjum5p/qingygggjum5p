...
extern void csp_coret_int_en(void);
extern void csp_coret_int_dis(void);
extern void csp_coret_wakeup_en(void);
extern void csp_coret_wakeup_dis(void);
extern void csp_coret_default_init(csp_coret_t *ptCoretBase);
extern void csp_coret_start(csp_coret_t *ptCoretBase);
extern void csp_coret_stop(csp_coret_t *ptCoretBase);
extern void csp_coret_clksrc_div8(csp_coret_t *ptCoretBase);
extern void csp_coret_clksrc_div1(csp_coret_t *ptCoretBase);
extern void csp_coret_tickint_en(csp_coret_t *ptCoretBase);
extern void csp_coret_tickint_dis(csp_coret_t *ptCoretBase);
extern void csp_coret_reload(csp_coret_t *ptCoretBase);
extern void csp_coret_set_rvr(csp_coret_t *ptCoretBase, uint32_t wVal);
