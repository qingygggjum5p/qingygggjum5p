 ...
 * @brief  gpio pull set 
****************************************************************************/
static inline void csp_gpio_pullhigh_set(csp_gpio_t *ptGpioBase,uint8_t byPinNum)
{
	ptGpioBase->PUDR  = ((ptGpioBase->PUDR) & ~(0x03 << (byPinNum*2))) | (0x01 << (byPinNum*2));
}

static inline void csp_gpio_pulllow_set(csp_gpio_t *ptGpioBase,uint8_t byPinNum)
{
	ptGpioBase->PUDR  = ((ptGpioBase->PUDR) & ~(0x03 << (byPinNum*2))) | (0x02 << (byPinNum*2));
}

static inline void csp_gpio_pullpighlow_dis(csp_gpio_t *ptGpioBase,uint8_t byPinNum)
{
 ...
 * @brief  gpio exi set 
****************************************************************************/
static inline void csp_gpio_int_dis(csp_gpio_t *ptGpioBase, gpio_exi_e eExiIo)
{
	ptGpioBase->IEDR  =  (1 << eExiIo);
}
static inline void csp_gpio_int_en(csp_gpio_t *ptGpioBase, gpio_exi_e eExiIo)
{
